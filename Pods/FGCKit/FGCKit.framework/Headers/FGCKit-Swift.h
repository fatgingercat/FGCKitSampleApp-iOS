...
#ifndef FGCKIT_SWIFT_H
#define FGCKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FGCKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("ReaderViewController")
@interface FGCReaderViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_PROTOCOL_NAMED("ReaderViewControllerDelegate")
@protocol FGCReaderViewControllerDelegate
- (void)didRequestDissmisal;
@end


/// Responsible for handling all delegate callbacks for the underlying session.
SWIFT_CLASS("_TtC6FGCKit15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(FGCKit)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(FGCKit)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(FGCKit)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(FGCKit)) <NSURLSessionTaskDelegate>
...
@property (nonatomic, readonly, copy) NSString * _Nullable storyDescription;
@property (nonatomic, readonly, copy) NSString * _Nullable coverURL;
@property (nonatomic, readonly, copy) NSArray<FGCAuthor *> * _Nonnull owners;
@property (nonatomic, readonly, copy) NSString * _Nullable authorName;
@property (nonatomic, readonly, copy) NSString * _Nullable illustratorName;
@property (nonatomic, readonly, copy) NSString * _Nullable narrtor;
...
@property (nonatomic, readonly, copy) NSString * _Nullable targetAge;
...
@property (nonatomic, readonly, strong) PayOption * _Nullable payingOption;
...
@interface FGCStory (SWIFT_EXTENSION(FGCKit))
@end


/// The task delegate is responsible for handling all delegate callbacks for the underlying task as well as
/// executing all operations attached to the serial operation queue upon task completion.
SWIFT_CLASS("_TtC6FGCKit12TaskDelegate")
...
@property (nonatomic, readonly) enum PaymentStatus payment;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface FGCUser (SWIFT_EXTENSION(FGCKit))
@end
